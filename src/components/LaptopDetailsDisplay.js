...
const LaptopDetailsDisplay = () => {
  ...
  // Fetch data from API
  useEffect(() => {
    axios.get(`http://localhost:3000/api/laptopName/${laptopName}`)
      .then(response => {
          ...
          <div className="col-md-6">
            <table className="custom-table">
              <tbody>
                ...
                <tr>
                  <td className="label-cell"><strong>RAM</strong></td>
                  <td className="value-cell">{item.RAM}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="label-cell"><strong>Resolution</strong></td>
                  <td className="value-cell">{item.resolution}</td>
                </tr>
                <tr>
                  <td className="label-cell"><strong>Batteries</strong></td>
                  <td className="value-cell">{item.batteries}</td>
                </tr>
                <tr>
...
export default LaptopDetailsDisplay;
