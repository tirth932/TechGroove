...
const RefriDetailsDisplay = () => {
  const [items, setItems] = useState([]);
  const [images, setImages] = useState([]);
  const [currentIndex, setCurrentIndex] = useState(0);
  const [fade, setFade] = useState(false);
  const { refriName } = useParams();
  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/api/refriName/${refriName}`)
      .then(response => {
  ...
  const handleProceed = () => {
    ...
    navigate(`/thank-you`); // Navigate to thank you page with product name
  };
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <table className="custom-table">
              <tbody>
                <tr>
                  <td className="label-cell"><strong>color</strong></td>
                ...
                <tr>
                  <td className="label-cell"><strong>brand</strong></td>
                  <td className="value-cell">
                    {item.brand}
                  </td>
                </tr>
                ...
                <tr>
                  <td className="label-cell"><strong>Voltage</strong></td>
                  <td className="value-cell">{item.voltage}</td>
                </tr>
                <tr>
...
export default RefriDetailsDisplay;
